...
class TelegramBot:
    ...
    def handle_message(self, update):
        ...
        if cmd in ("/start", "/help"):
            ...
            if IS_BATCH_RUNNING:
                self.send_message(chat_id, "⚠️ <b>A batch signup process is ALREADY running!</b>\nPlease wait for the current batch to complete.")
                return
            ...
            self.send_message(chat_id, f"🚀 <b>Starting Ultra-Fast Batch Signup for {len(pending)} numbers!</b>\n<i>Only successful account registrations will notify this chat.</i>")
